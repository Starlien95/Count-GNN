...
if __name__ == "__main__":
    ...
    parser.add_argument("--number_of_vertices", type=int, default=8)
    parser.add_argument("--number_of_edges", type=int, default=8)
    parser.add_argument("--number_of_vertex_labels", type=int, default=10)
    parser.add_argument("--number_of_edge_labels", type=int, default=1)
    parser.add_argument("--number_of_patterns", type=int, default=4)
    parser.add_argument("--save_dir", type=str, default="../data/NCI1/patterns")
    ...
    if args.save_dir:
        ...
        for p, pattern in enumerate(patterns):
            pattern_id = "P_N%d_E%d_NL%d_%d" % (
                args.number_of_vertices, args.number_of_edges, args.number_of_vertex_labels, p)
