...
if __name__ == "__main__":
    ...
    parser.add_argument("--pattern_path", type=str,default="../data/MUTAG/patterns/P_N3_E2_NL1_EL1_0.gml")
    parser.add_argument("--save_graph_dir", type=str, default="../data/MUTAG/graphs")
    parser.add_argument("--save_metadata_dir", type=str, default="../data/MUTAG/metadata")
