...
if __name__ == "__main__":
    ...
    nodes = list()
    node2graph = list()
    with open(os.path.join(nci1_data_path, "NCI1_graph_indicator.txt"), "r") as f:
    ...
    with open(os.path.join(nci1_data_path, "NCI1_node_labels.txt"), "r") as f:
        _nodelabels = list()
        for nl in f:
            nl = int(nl)
    ...
    with open(os.path.join(nci1_data_path, "NCI1_A.txt"), "r") as f:
        for e in f:
